...
class User extends Authenticatable implements JWTSubject
{
     ...
     * @var array
     */
    protected $fillable = ['role_id', 'city_id', 'district_id', 'name', 'email','password','phone','Gender','Age','scout', 'block', 'isActive','verify_code','isVerified', 'forgot_code', 'api_token', 'fcm_tocken','lng','lat', 'created_at', 'updated_at'];
